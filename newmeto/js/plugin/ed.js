...
Dialog.prototype = {
	...
	createDialogWrap : function( tmpl ){
		...
		var header = tmpl.header ? 
			'<h4 class="easyDialog_title" id="easyDialogTitle"><a href="javascript:void(0)" title="关闭窗口" class="close_btn ui-deg360" id="closeBtn"><i class="ui-deg-icon iconfont">ß</i></a>' + tmpl.header + '</h4>' :
			'',
			// 确定按钮
